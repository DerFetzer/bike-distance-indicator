...
use stm32f1xx_hal::gpio::gpioa::{PA2, PA4, PA5, PA6, PA7, PA3};
use stm32f1xx_hal::gpio::gpiob::{PB0, PB13, PB14, PB15};
use stm32f1xx_hal::gpio::{Alternate, Floating, Input, Output, PushPull, Analog};
...
pub type WsType = ws2812_spi::Ws2812<stm32f1xx_hal::spi::Spi<stm32f1xx_hal::pac::SPI2, Spi2NoRemap, (PB13<Alternate<PushPull>>, PB14<Input<Floating>>, PB15<Alternate<PushPull>>), u8>>;
